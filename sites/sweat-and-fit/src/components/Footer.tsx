            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="text-white">{siteConfig.timings.morning}</p>
                </div>
              </li>
              <li className="flex items-start gap-3 text-sm">
                <Clock className="w-4 h-4 text-[#C9A962] mt-0.5 flex-shrink-0" />
                <div>
                  ...
                  <p className="text-white">{siteConfig.timings.evening}</p>
                </div>
              </li>
              <li className="flex items-start gap-3 text-sm">
                <Clock className="w-4 h-4 text-[#C9A962] mt-0.5 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Sweat AND Fit. All rights reserved.
            </p>
            <p className="text-gray-500 text-sm">
