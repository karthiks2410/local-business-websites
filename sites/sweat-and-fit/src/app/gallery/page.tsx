...
// Instagram SVG icon since lucide-react doesn't have it
...
export const metadata: Metadata = {
  title: "Gallery",
  description: "Take a virtual tour of Sweat AND Fit gym - see our equipment, facilities, and atmosphere.",
};

// Placeholder gallery items - will be replaced with real photos
const galleryItems = [
  { id: 1, title: "Strength Zone", category: "Equipment" },
  { id: 2, title: "Cardio Area", category: "Equipment" },
  { id: 3, title: "Free Weights", category: "Equipment" },
  ...
  { id: 9, title: "Steam Room", category: "Facility" },
];
          ...
          <ScrollReveal>
            <div className="flex items-center justify-center gap-3 p-4 bg-[#C9A962]/10 border border-[#C9A962]/20 rounded-xl">
              ...
              <p className="text-[#C9A962] text-sm">
                Photos coming soon! We&apos;re capturing our brand new facility. Check back after our grand opening!
              </p>
            </div>
          </ScrollReveal>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <p className="text-gray-400 text-lg mb-8">
              Nothing beats experiencing our facility firsthand. Visit us at our grand opening!
            </p>
